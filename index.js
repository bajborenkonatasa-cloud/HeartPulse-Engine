...
[[/HEARTPULSE_STATE]]
Do NOT wrap this packet in a code fence, XML, HTML comment, markdown, or prose. Do not put anything after the closing boundary. HeartPulse removes this packet locally before normal rendering. ${calibration} Keep text fields compact and in Russian. NPCs: if any named NPC other than the main character is present, mentioned, or materially relevant in the current reply/context, include that NPC in the npc array and give them a small persistent profile. Do not omit an active named NPC just because their state changed only slightly.
...
function panelHtml(){
  ...
  return `<div id="hpOverlay" class="hp-overlay hp-hidden"><div id="hpPanel" class="hp-panel">
    <header class="hp-head"><div><div class="hp-kicker">HEARTPULSE ENGINE · v0.9.9.1</div><h2>❤️‍🔥✨ ${name}</h2><p>Живая анкета персонажа · связь · искра · цели · NPC</p></div><button class="hp-close">×</button></header>
